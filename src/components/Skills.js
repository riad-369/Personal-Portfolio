...
const Skills = () => {
    return(
      <>
       ...
       lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] l
       g:bg-circularLightLg lg:dark:bg-circularDarkLg 
       ...
       '>
             ...
             <Skill name="C" x="0vw" y="-18.5vw" />
             <Skill name="C++" x="-27vw" y="19vw" />
             <Skill name="SQL" x="19vw" y="18vw" />
